...
import {
    ...
    RENEW_FEE_START,RENEW_FEE_END,
    TASK_USER_START, TASK_USER_END
} from '../constants/index'


export default class NeedRenewFeeContainer extends Component {
    constructor(props) {
        super(props);
        /*attribute*/
        this.page = 0;
    ...
    componentDidMount() {
        ...
        this.props.dispatch(getListByMutilpCondition({"renew_fee_status": 1}, USER_COUNT_OF_MANAGER_START, USER_COUNT_OF_MANAGER_END, user_count_of_manager));
    }
        ...
        switch (this.optPage) {
            ...
            case business_operation_action.DELETE:
                ...
                self.props.dispatch(deleteObject({
                    "ids": self.selectedItems,
                    "admin_id":1
                }, RENEW_FEE_START, RENEW_FEE_END, renew_fee, function (json) {
                    self.selectedItems.splice(0);
                    self.operationStatus = business_operation_status.SUCCESS;
                ...
                <div id="main">
                    ...
                    <div id="content" className="after-mail-box" style={{top: "75px", padding: "15px 18px 0"}}>
                        <Operations title={this.selectedManagerName} smallTitle="团队" operationStatus={this.operationStatus}
                                    ...
                                    _doAction={this._doAction} addBtnHidden={true} editBtnHidden={true} deleteText="确认完成" contentTip="完成续费"/>
...
class ManagersList extends Component {
    ...
    render() {
        ...
        console.log("userCountOfManager",userCountOfManager);
        var self = this;
        return (
            <div id="nav-scroll">
                                ...
                                return <li key={key}
                                    ...
                                    <div onClick={self._changeManager.bind(self, key, val.id,val.name)}
                                        ...
                                        <time className="timeago" dateTime={val.register_date}
                                            ...
                                            - {"待续费人数 : " + (userCountOfManager.data && userCountOfManager.data[val.id] ? userCountOfManager.data[val.id] : 0)}
                                        </time>
                ...
                <div className="panel-body" style={{padding: "1px"}}>
                    <table className="table table-hover">
                        ...
                        {renderList(userListByManager, function (rows) {
                            return rows.map(function (val, key) {
                                return <tr key={key}>
                                    <td><input type="checkbox" value={val.id+"_"+formatDate(val.plan_renew_fee_date, "yyyy-mm-dd")} name="member"
...
export default connect(mapStateToProps)(NeedRenewFeeContainer)